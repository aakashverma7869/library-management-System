       ...
       <br>
        ...
        <div class="col-md-12">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a  class="btn btn-primary" href="RegisterBook.jsp">Add New Book</a></li>
                <li><a  class="btn btn-primary" href="RegisterStudent.jsp">Add New Student</a></li>
                <li><a  class="btn btn-primary" href="ConfirmIssue.jsp">Confirm Issue</a></li>
                <li><a  class="btn btn-primary" href="AdminSignup.jsp">Add New Admin</a></li>
                <li><a  class="btn btn-primary" href="ReturnBook.jsp">Book Return</a></li>
                <li><a  class="btn btn-primary" href="AAbook.jsp">Books Availability</a></li>
                <li><a  class="btn btn-primary" href="StudentFine.jsp">Student Record</a></li>
